                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ route('updateProperty', $property->id) }}" method="post"
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category_id" id="exampleSelectGender" value='{{ $property->category->name }}'>
